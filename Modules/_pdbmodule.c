...
static PyMethodDef methods[] = {
        ACTIVATE_DEBUGGER_INTERFACE_METHODDEF
        {NULL, NULL, 0, NULL},
};

static struct PyModuleDef _pdbmodule = {
...
PyInit__pdb(void)
{
    PyObject* mod = PyModule_Create(&_pdbmodule);
    if (mod == NULL) {
        return NULL;
    }
