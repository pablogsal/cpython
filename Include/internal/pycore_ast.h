...
enum _expr_kind {BoolOp_kind=1, NamedExpr_kind=2, BinOp_kind=3,
                  CoalesceOp_kind=4, UnaryOp_kind=5, Lambda_kind=6,
                  IfExp_kind=7, Dict_kind=8, Set_kind=9, ListComp_kind=10,
                  SetComp_kind=11, DictComp_kind=12, GeneratorExp_kind=13,
...
expr_ty _PyAST_BinOp(expr_ty left, operator_ty op, expr_ty right, int lineno,
                     int col_offset, int end_lineno, int end_col_offset,
                     PyArena *arena);
expr_ty _PyAST_CoalesceOp(expr_ty left, coalesceop_ty op, expr_ty right, int
                          lineno, int col_offset, int end_lineno, int
                          end_col_offset, PyArena *arena);
